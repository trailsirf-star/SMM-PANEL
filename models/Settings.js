...
const settingsSchema = new mongoose.Schema(
  {
    ...
    // Binance Pay — additive fields, safe defaults, mirrors the Easypaisa pattern
    binanceId: { type: String, default: '' },
    binancePayLabel: { type: String, default: 'Binance Pay ID' },
...
settingsSchema.statics.getSettings = async function () {
  ...
  // binanceId and binancePayLabel default to '' / 'Binance Pay ID' — no coercion needed
  if (!settings.binancePayLabel) settings.binancePayLabel = 'Binance Pay ID';
